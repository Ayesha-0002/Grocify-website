...
const Navbar = () => {
    ...
    return (
        <header className={`bg-white fixed top-0 right-0 left-0 z-50 ${isScrolled ? 'shadow-[0_4px_25px_rgba(0,0,0,0.1)]' : ''}`}>
            ...
            <nav className='max-w-[1400px] mx-auto md:h-[14vh] h-[12vh] px-10 flex justify-between items-center relative'>

                {/* Logo */}
                <Link to="/" className="text-3xl font-bold">Gr<span className="text-orange-500 uppercase">o</span>cify
                </Link>
                ...
                <ul className={`flex flex-col items-center bg-orange-500/15 backdrop-blur-xl shadow-xl rounded-xl p-10 gap-y-12 md:hidden absolute top-24 -left-full -translate-x-1/2 transition-all duration-500 ${ShowMenu ? 'left-1/2' : ''}`}>
                    <li><a href="#" className="font-semibold tracking-wider text-orange-500">Home</a></li>
                    <li><a href="#" className="font-semibold tracking-wider text-zinc-800 hover:text-orange-500">About Us</a></li>
                    <li><a href="#" className="font-semibold tracking-wider text-zinc-800 hover:text-orange-500">Process</a></li>
                    <li><a href="#" className="font-semibold tracking-wider text-zinc-800 hover:text-orange-500">Contact Us</a></li>
